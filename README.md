...
A partir de ahí, cada vez que añadas un importe, un gasto, deshagas,
...
- Cada licencia solo ve y edita **sus propios días** (los datos se guardan
  ...
  consola para meter importes — solo entra en un panel donde puede
...
Mientras vas metiendo importes y gastos del día, todo se guarda al
